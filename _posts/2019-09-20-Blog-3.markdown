...
in particular that are very simple to get started with and use to do the job such as *insertafter*, *line*, *mode*, *regexp*.  Here is an example we can break down
